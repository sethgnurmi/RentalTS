    ...
    <div class="row">
      <div class="col-sm-12">
        ...
        <div class="row panel-card-container" style="min-height:40px;">
          <?=(count($OrderList) == 0) ? "<center><b>No pending shipping assignments.</b></b></center>" : "" ?>
          <? foreach($OrderList as $key => $Order){ ?>
          <div class="col-sm-4 panel-card-outer">
            <div class="panel-card">
              <h4><strong>Order #<?=$Order['actor_id']?></strong><a class="inline-view" style="style:right;" onclick="window.location='<?=base_url();?>Shipping/Order/<?=$Order['actor_id']?>'">Confirm Shipping</a></h4>
