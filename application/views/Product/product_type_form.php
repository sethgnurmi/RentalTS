...
<div style="padding-left: calc(100vw - 100%);">
  ...
  <div class="container" id="ContentWrapper">
    ...
    <form action="http://localhost/RentalTS/Products/Type" id="ProductForm" method="post" accept-charset="utf-8">
    <input type="hidden" id="ProductId" name="ProductId" value="<?=$ProductType['ProductTypeId']?>">
    <div class="row">
      <div class="col-sm-12">
        <div class="row panel-header">
          ...
          <?}else{?>
          <div class="panel-header-button">Product Type #<?=$ProductType['ProductTypeId'];?></div>
          <?}?>
