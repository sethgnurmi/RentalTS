...
<table class="pf-c-table pf-m-expandable pf-m-grid-md" role="grid" aria-label="Compound expandable table example" id="table-compound-expansion">
  ...
  <tbody class="pf-m-expanded" role="rowgroup">
    <tr class="pf-c-table__control-row" role="row">
      <td class="pf-c-table__compound-expansion-togglepf-m-expanded pf-m-expanded" role="cell" data-label="Repositories">
        <button class="pf-c-table__button">
...
```html
<table class="pf-c-table pf-m-tree-view" role="treegrid" aria-label="This is a simple tree table example" id="tree-table-basic">
  <caption>This is the table caption</caption>
  <thead>
    <tr>
  ...
  <tbody>
    <tr aria-level="1" aria-setsize="1" aria-posinset="1" tabindex="0" aria-expanded="true" role="row">
      <td role="gridcell" data-label="Tree view content">
        <div class="pf-c-table__tree-view-main">
          <span class="pf-c-table__toggle" data-label="Tree view content">
            <button class="pf-c-button pf-m-plain pf-m-expanded" aria-labelledby="tree-table-basic-node-2 tree-table-basic-expandable-toggle-2" id="tree-table-basic-expandable-toggle-2" aria-label="Details" aria-expanded="true">
              <div class="pf-c-table__toggle-icon">
                <i class="fas fa-angle-down" aria-hidden="true"></i>
              </div>
            </button>
          </span>
          <div class="pf-c-table__tree-view-content">
            <span class="pf-c-table__text" id="tree-table-basic-node-2">Level 1 all folders</span>
          </div>
        </div>
      </td>
    ...
    <tr aria-level="2" aria-setsize="5" aria-posinset="1" tabindex="0" aria-expanded="false" role="row">
      <td role="gridcell" data-label="Tree view content">
        <div class="pf-c-table__tree-view-main">
          <span class="pf-c-table__toggle" data-label="Tree view content">
            <button class="pf-c-button pf-m-plain" aria-labelledby="tree-table-basic-node-3 tree-table-basic-expandable-toggle-3" id="tree-table-basic-expandable-toggle-3" aria-label="Details">
              <div class="pf-c-table__toggle-icon">
                <i class="fas fa-angle-down" aria-hidden="true"></i>
              </div>
            </button>
          ...
          <div class="pf-c-table__tree-view-content">
            <span class="pf-c-table__text" id="tree-table-basic-node-3">Level 2 node</span>
          </div>
        </div>
      </td>
      <td role="gridcell" data-label="Migration assessment">10</td>
    ...
    <tr aria-level="3" aria-setsize="2" aria-posinset="1" tabindex="-1" hidden role="row">
      <td role="gridcell" data-label="Tree view content">
        <div class="pf-c-table__tree-view-main">
          <div class="pf-c-table__tree-view-content">
            <span class="pf-c-table__text" id="tree-table-basic-node-4">Level 2 leaf</span>
          </div>
        </div>
      </td>
      <td role="gridcell" data-label="Migration assessment">10</td>
    ...
    <tr aria-level="3" aria-setsize="2" aria-posinset="2" tabindex="-1" hidden role="row">
      <td role="gridcell" data-label="Tree view content">
        <div class="pf-c-table__tree-view-main">
          <div class="pf-c-table__tree-view-content">
            <span class="pf-c-table__text" id="tree-table-basic-node-5">Level 2 leaf</span>
          </div>
        </div>
      </td>
      <td role="gridcell" data-label="Migration assessment">10</td>
    ...
    <tr aria-level="2" aria-setsize="5" aria-posinset="2" tabindex="-1" role="row">
      <td role="gridcell" data-label="Tree view content">
        <div class="pf-c-table__tree-view-main">
          <div class="pf-c-table__tree-view-content">
            <span class="pf-c-table__text" id="tree-table-basic-node-6">Level 2 leaf</span>
          </div>
        </div>
      </td>
      <td role="gridcell" data-label="Migration assessment">10</td>
    ...
    <tr aria-level="2" aria-setsize="5" aria-posinset="3" tabindex="-1" role="row">
      <td role="gridcell" data-label="Tree view content">
        <div class="pf-c-table__tree-view-main">
          <div class="pf-c-table__tree-view-content">
            <span class="pf-c-table__text" id="tree-table-basic-node-7">Level 2 leaf</span>
          </div>
        </div>
      </td>
      <td role="gridcell" data-label="Migration assessment">10</td>
    ...
    <tr aria-level="2" aria-setsize="5" aria-posinset="4" tabindex="0" aria-expanded="true" role="row">
      <td role="gridcell" data-label="Tree view content">
        <div class="pf-c-table__tree-view-main">
          <span class="pf-c-table__toggle" data-label="Tree view content">
            <button class="pf-c-button pf-m-plain pf-m-expanded" aria-labelledby="tree-table-basic-node-8 tree-table-basic-expandable-toggle-8" id="tree-table-basic-expandable-toggle-8" aria-label="Details" aria-expanded="true">
              <div class="pf-c-table__toggle-icon">
                <i class="fas fa-angle-down" aria-hidden="true"></i>
              </div>
            </button>
          ...
          <div class="pf-c-table__tree-view-content">
            <span class="pf-c-table__text" id="tree-table-basic-node-8">Level 2 node</span>
          </div>
        </div>
      </td>
      <td role="gridcell" data-label="Migration assessment">10</td>
    ...
    <tr aria-level="3" aria-setsize="2" aria-posinset="3" tabindex="-1" role="row">
      <td role="gridcell" data-label="Tree view content">
        <div class="pf-c-table__tree-view-main">
          <div class="pf-c-table__tree-view-content">
            <span class="pf-c-table__text" id="tree-table-basic-node-9">Level 3 leaf</span>
          </div>
        </div>
      </td>
      <td role="gridcell" data-label="Migration assessment">10</td>
    ...
    <tr aria-level="3" aria-setsize="2" aria-posinset="1" tabindex="0" aria-expanded="true" role="row">
      <td role="gridcell" data-label="Tree view content">
        <div class="pf-c-table__tree-view-main">
          <span class="pf-c-table__toggle" data-label="Tree view content">
            <button class="pf-c-button pf-m-plain pf-m-expanded" aria-labelledby="tree-table-basic-node-11 tree-table-basic-expandable-toggle-11" id="tree-table-basic-expandable-toggle-11" aria-label="Details" aria-expanded="true">
              <div class="pf-c-table__toggle-icon">
                <i class="fas fa-angle-down" aria-hidden="true"></i>
              </div>
            </button>
          ...
          <div class="pf-c-table__tree-view-content">
            <span class="pf-c-table__text" id="tree-table-basic-node-11">Level 3 node</span>
          </div>
        </div>
      </td>
      <td role="gridcell" data-label="Migration assessment">10</td>
    ...
    <tr aria-level="4" aria-setsize="1" aria-posinset="1" tabindex="-1" role="row">
      <td role="gridcell" data-label="Tree view content">
        <div class="pf-c-table__tree-view-main">
          <div class="pf-c-table__tree-view-content">
            <span class="pf-c-table__text" id="tree-table-basic-node-12">Level 4 leaf</span>
          </div>
        </div>
      </td>
      <td role="gridcell" data-label="Migration assessment">10</td>
    ...
    <tr aria-level="3" aria-setsize="2" aria-posinset="2" tabindex="-1" role="row">
      <td role="gridcell" data-label="Tree view content">
        <div class="pf-c-table__tree-view-main">
          <div class="pf-c-table__tree-view-content">
            <span class="pf-c-table__text" id="tree-table-basic-node-13">Level 3 leaf</span>
          </div>
        </div>
      </td>
      <td role="gridcell" data-label="Migration assessment">10</td>
    ...
    <tr aria-level="3" aria-setsize="2" aria-posinset="5" tabindex="0" aria-expanded="true" role="row">
      <td role="gridcell" data-label="Tree view content">
        <div class="pf-c-table__tree-view-main">
          <span class="pf-c-table__toggle" data-label="Tree view content">
            <button class="pf-c-button pf-m-plain pf-m-expanded" aria-labelledby="tree-table-basic-node-14 tree-table-basic-expandable-toggle-14" id="tree-table-basic-expandable-toggle-14" aria-label="Details" aria-expanded="true">
              <div class="pf-c-table__toggle-icon">
                <i class="fas fa-angle-down" aria-hidden="true"></i>
              </div>
            </button>
          ...
          <div class="pf-c-table__tree-view-content">
            <span class="pf-c-table__text" id="tree-table-basic-node-14">Level 3 node</span>
          </div>
        </div>
      </td>
      <td role="gridcell" data-label="Migration assessment">10</td>
    ...
    <tr aria-level="4" aria-setsize="2" aria-posinset="1" tabindex="-1" role="row">
      <td role="gridcell" data-label="Tree view content">
        <div class="pf-c-table__tree-view-main">
          <div class="pf-c-table__tree-view-content">
            <span class="pf-c-table__text" id="tree-table-basic-node-15">Level 4 leaf</span>
          </div>
        </div>
      </td>
      <td role="gridcell" data-label="Migration assessment">10</td>
    ...
    <tr aria-level="4" aria-setsize="2" aria-posinset="2" tabindex="-1" role="row">
      <td role="gridcell" data-label="Tree view content">
        <div class="pf-c-table__tree-view-main">
          <div class="pf-c-table__tree-view-content">
            <span class="pf-c-table__text" id="tree-table-basic-node-16">Level 4 leaf</span>
          </div>
        </div>
      </td>
      <td role="gridcell" data-label="Migration assessment">10</td>
    ...
    <tr aria-level="2" aria-setsize="5" aria-posinset="6" tabindex="0" aria-expanded="false" role="row">
      <td role="gridcell" data-label="Tree view content">
        <div class="pf-c-table__tree-view-main">
          <span class="pf-c-table__toggle" data-label="Tree view content">
            <button class="pf-c-button pf-m-plain" aria-labelledby="tree-table-basic-node-17 tree-table-basic-expandable-toggle-17" id="tree-table-basic-expandable-toggle-17" aria-label="Details">
              <div class="pf-c-table__toggle-icon">
                <i class="fas fa-angle-down" aria-hidden="true"></i>
              </div>
            </button>
          ...
          <div class="pf-c-table__tree-view-content">
            <span class="pf-c-table__text" id="tree-table-basic-node-17">Level 2 node</span>
          </div>
        </div>
      </td>
      <td role="gridcell" data-label="Migration assessment">10</td>
    ...
    <tr aria-level="3" aria-setsize="2" aria-posinset="1" tabindex="-1" hidden role="row">
      <td role="gridcell" data-label="Tree view content">
        <div class="pf-c-table__tree-view-main">
          <div class="pf-c-table__tree-view-content">
            <span class="pf-c-table__text" id="tree-table-basic-node-18">Level 3 leaf</span>
          </div>
        </div>
      </td>
      <td role="gridcell" data-label="Migration assessment">10</td>
    ...
    <tr aria-level="3" aria-setsize="2" aria-posinset="2" tabindex="-1" hidden role="row">
      <td role="gridcell" data-label="Tree view content">
        <div class="pf-c-table__tree-view-main">
          <div class="pf-c-table__tree-view-content">
            <span class="pf-c-table__text" id="tree-table-basic-node-19">Level 3 leaf</span>
          </div>
        </div>
      </td>
      <td role="gridcell" data-label="Migration assessment">10</td>
...
```html
<table class="pf-c-table pf-m-tree-view pf-m-tree-view-checkboxes" role="treegrid" aria-label="This is a simple tree table, with checkboxes example" id="tree-table-with-checkboxes">
  <caption>This is the table caption</caption>
  <thead>
    <tr>
      <th scope="col">Name</th>
  ...
  <tbody>
    <tr aria-level="1" aria-setsize="1" aria-posinset="1" tabindex="0" aria-expanded="true" role="row">
      <td role="gridcell" data-label="Tree view content">
        <div class="pf-c-table__tree-view-main">
          <span class="pf-c-table__toggle" data-label="Tree view content">
            <button class="pf-c-button pf-m-plain pf-m-expanded" aria-labelledby="tree-table-with-checkboxes-node-2 tree-table-with-checkboxes-expandable-toggle-2" id="tree-table-with-checkboxes-expandable-toggle-2" aria-label="Details" aria-expanded="true">
              <div class="pf-c-table__toggle-icon">
                <i class="fas fa-angle-down" aria-hidden="true"></i>
              </div>
            </button>
          </span>
          <span class="pf-c-table__check" data-label="Tree view content">
            <input type="checkbox" name="tree-table-with-checkboxes-checkrow-2" aria-labelledby="tree-table-with-checkboxes-node-2" />
          </span>
          <div class="pf-c-table__tree-view-content">
            <span class="pf-c-table__text" id="tree-table-with-checkboxes-node-2">Level 1 all folders</span>
          </div>
        </div>
      </td>
      <td role="gridcell" data-label="Migration assessment">10</td>
    ...
    <tr aria-level="2" aria-setsize="5" aria-posinset="1" tabindex="0" aria-expanded="false" role="row">
      <td role="gridcell" data-label="Tree view content">
        <div class="pf-c-table__tree-view-main">
          <span class="pf-c-table__toggle" data-label="Tree view content">
            <button class="pf-c-button pf-m-plain" aria-labelledby="tree-table-with-checkboxes-node-3 tree-table-with-checkboxes-expandable-toggle-3" id="tree-table-with-checkboxes-expandable-toggle-3" aria-label="Details">
              <div class="pf-c-table__toggle-icon">
                <i class="fas fa-angle-down" aria-hidden="true"></i>
              </div>
            </button>
          ...
          <span class="pf-c-table__check" data-label="Tree view content">
            <input type="checkbox" name="tree-table-with-checkboxes-checkrow-3" aria-labelledby="tree-table-with-checkboxes-node-3" />
          </span>
          <div class="pf-c-table__tree-view-content">
            <span class="pf-c-table__text" id="tree-table-with-checkboxes-node-3">Level 2 node</span>
          </div>
        </div>
      </td>
      <td role="gridcell" data-label="Migration assessment">10</td>
    ...
    <tr aria-level="3" aria-setsize="2" aria-posinset="1" tabindex="-1" hidden role="row">
      <td role="gridcell" data-label="Tree view content">
        <div class="pf-c-table__tree-view-main">
          <span class="pf-c-table__check" data-label="Tree view content">
            <input type="checkbox" name="tree-table-with-checkboxes-checkrow-4" aria-labelledby="tree-table-with-checkboxes-node-4" />
          </span>
          <div class="pf-c-table__tree-view-content">
            <span class="pf-c-table__text" id="tree-table-with-checkboxes-node-4">Level 2 leaf</span>
          </div>
        </div>
      </td>
      <td role="gridcell" data-label="Migration assessment">10</td>
    ...
    <tr aria-level="3" aria-setsize="2" aria-posinset="2" tabindex="-1" hidden role="row">
      <td role="gridcell" data-label="Tree view content">
        <div class="pf-c-table__tree-view-main">
          <span class="pf-c-table__check" data-label="Tree view content">
            <input type="checkbox" name="tree-table-with-checkboxes-checkrow-5" aria-labelledby="tree-table-with-checkboxes-node-5" />
          </span>
          <div class="pf-c-table__tree-view-content">
            <span class="pf-c-table__text" id="tree-table-with-checkboxes-node-5">Level 2 leaf</span>
          </div>
        </div>
      </td>
      <td role="gridcell" data-label="Migration assessment">10</td>
    ...
    <tr aria-level="2" aria-setsize="5" aria-posinset="2" tabindex="-1" role="row">
      <td role="gridcell" data-label="Tree view content">
        <div class="pf-c-table__tree-view-main">
          <span class="pf-c-table__check" data-label="Tree view content">
            <input type="checkbox" name="tree-table-with-checkboxes-checkrow-6" aria-labelledby="tree-table-with-checkboxes-node-6" />
          </span>
          <div class="pf-c-table__tree-view-content">
            <span class="pf-c-table__text" id="tree-table-with-checkboxes-node-6">Level 2 leaf</span>
          </div>
        </div>
      </td>
      <td role="gridcell" data-label="Migration assessment">10</td>
    ...
    <tr aria-level="2" aria-setsize="5" aria-posinset="3" tabindex="-1" role="row">
      <td role="gridcell" data-label="Tree view content">
        <div class="pf-c-table__tree-view-main">
          <span class="pf-c-table__check" data-label="Tree view content">
            <input type="checkbox" name="tree-table-with-checkboxes-checkrow-7" aria-labelledby="tree-table-with-checkboxes-node-7" />
          </span>
          <div class="pf-c-table__tree-view-content">
            <span class="pf-c-table__text" id="tree-table-with-checkboxes-node-7">Level 2 leaf</span>
          </div>
        </div>
      </td>
      <td role="gridcell" data-label="Migration assessment">10</td>
    ...
    <tr aria-level="2" aria-setsize="5" aria-posinset="4" tabindex="0" aria-expanded="true" role="row">
      <td role="gridcell" data-label="Tree view content">
        <div class="pf-c-table__tree-view-main">
          <span class="pf-c-table__toggle" data-label="Tree view content">
            <button class="pf-c-button pf-m-plain pf-m-expanded" aria-labelledby="tree-table-with-checkboxes-node-8 tree-table-with-checkboxes-expandable-toggle-8" id="tree-table-with-checkboxes-expandable-toggle-8" aria-label="Details" aria-expanded="true">
              <div class="pf-c-table__toggle-icon">
                <i class="fas fa-angle-down" aria-hidden="true"></i>
              </div>
            </button>
          ...
          <span class="pf-c-table__check" data-label="Tree view content">
            <input type="checkbox" name="tree-table-with-checkboxes-checkrow-8" aria-labelledby="tree-table-with-checkboxes-node-8" />
          </span>
          <div class="pf-c-table__tree-view-content">
            <span class="pf-c-table__text" id="tree-table-with-checkboxes-node-8">Level 2 node</span>
          </div>
        </div>
      </td>
      <td role="gridcell" data-label="Migration assessment">10</td>
    ...
    <tr aria-level="3" aria-setsize="2" aria-posinset="3" tabindex="-1" role="row">
      <td role="gridcell" data-label="Tree view content">
        <div class="pf-c-table__tree-view-main">
          <span class="pf-c-table__check" data-label="Tree view content">
            <input type="checkbox" name="tree-table-with-checkboxes-checkrow-9" aria-labelledby="tree-table-with-checkboxes-node-9" />
          </span>
          <div class="pf-c-table__tree-view-content">
            <span class="pf-c-table__text" id="tree-table-with-checkboxes-node-9">Level 3 leaf</span>
          </div>
        </div>
      </td>
      <td role="gridcell" data-label="Migration assessment">10</td>
    ...
    <tr aria-level="3" aria-setsize="2" aria-posinset="1" tabindex="0" aria-expanded="true" role="row">
      <td role="gridcell" data-label="Tree view content">
        <div class="pf-c-table__tree-view-main">
          <span class="pf-c-table__toggle" data-label="Tree view content">
            <button class="pf-c-button pf-m-plain pf-m-expanded" aria-labelledby="tree-table-with-checkboxes-node-11 tree-table-with-checkboxes-expandable-toggle-11" id="tree-table-with-checkboxes-expandable-toggle-11" aria-label="Details" aria-expanded="true">
              <div class="pf-c-table__toggle-icon">
                <i class="fas fa-angle-down" aria-hidden="true"></i>
              </div>
            </button>
          ...
          <span class="pf-c-table__check" data-label="Tree view content">
            <input type="checkbox" name="tree-table-with-checkboxes-checkrow-11" aria-labelledby="tree-table-with-checkboxes-node-11" />
          </span>
          <div class="pf-c-table__tree-view-content">
            <span class="pf-c-table__text" id="tree-table-with-checkboxes-node-11">Level 3 node</span>
          </div>
        </div>
      </td>
      <td role="gridcell" data-label="Migration assessment">10</td>
    ...
    <tr aria-level="4" aria-setsize="1" aria-posinset="1" tabindex="-1" role="row">
      <td role="gridcell" data-label="Tree view content">
        <div class="pf-c-table__tree-view-main">
          <span class="pf-c-table__check" data-label="Tree view content">
            <input type="checkbox" name="tree-table-with-checkboxes-checkrow-12" aria-labelledby="tree-table-with-checkboxes-node-12" />
          </span>
          <div class="pf-c-table__tree-view-content">
            <span class="pf-c-table__text" id="tree-table-with-checkboxes-node-12">Level 4 leaf</span>
          </div>
        </div>
      </td>
      <td role="gridcell" data-label="Migration assessment">10</td>
    ...
    <tr aria-level="3" aria-setsize="2" aria-posinset="2" tabindex="-1" role="row">
      <td role="gridcell" data-label="Tree view content">
        <div class="pf-c-table__tree-view-main">
          <span class="pf-c-table__check" data-label="Tree view content">
            <input type="checkbox" name="tree-table-with-checkboxes-checkrow-13" aria-labelledby="tree-table-with-checkboxes-node-13" />
          </span>
          <div class="pf-c-table__tree-view-content">
            <span class="pf-c-table__text" id="tree-table-with-checkboxes-node-13">Level 3 leaf</span>
          </div>
        </div>
      </td>
      <td role="gridcell" data-label="Migration assessment">10</td>
    ...
    <tr aria-level="3" aria-setsize="2" aria-posinset="5" tabindex="0" aria-expanded="true" role="row">
      <td role="gridcell" data-label="Tree view content">
        <div class="pf-c-table__tree-view-main">
          <span class="pf-c-table__toggle" data-label="Tree view content">
            <button class="pf-c-button pf-m-plain pf-m-expanded" aria-labelledby="tree-table-with-checkboxes-node-14 tree-table-with-checkboxes-expandable-toggle-14" id="tree-table-with-checkboxes-expandable-toggle-14" aria-label="Details" aria-expanded="true">
              <div class="pf-c-table__toggle-icon">
                <i class="fas fa-angle-down" aria-hidden="true"></i>
              </div>
            </button>
          ...
          <span class="pf-c-table__check" data-label="Tree view content">
            <input type="checkbox" name="tree-table-with-checkboxes-checkrow-14" aria-labelledby="tree-table-with-checkboxes-node-14" />
          </span>
          <div class="pf-c-table__tree-view-content">
            <span class="pf-c-table__text" id="tree-table-with-checkboxes-node-14">Level 3 node</span>
          </div>
        </div>
      </td>
      <td role="gridcell" data-label="Migration assessment">10</td>
    ...
    <tr aria-level="4" aria-setsize="2" aria-posinset="1" tabindex="-1" role="row">
      <td role="gridcell" data-label="Tree view content">
        <div class="pf-c-table__tree-view-main">
          <span class="pf-c-table__check" data-label="Tree view content">
            <input type="checkbox" name="tree-table-with-checkboxes-checkrow-15" aria-labelledby="tree-table-with-checkboxes-node-15" />
          </span>
          <div class="pf-c-table__tree-view-content">
            <span class="pf-c-table__text" id="tree-table-with-checkboxes-node-15">Level 4 leaf</span>
          </div>
        </div>
      </td>
      <td role="gridcell" data-label="Migration assessment">10</td>
    ...
    <tr aria-level="4" aria-setsize="2" aria-posinset="2" tabindex="-1" role="row">
      <td role="gridcell" data-label="Tree view content">
        <div class="pf-c-table__tree-view-main">
          <span class="pf-c-table__check" data-label="Tree view content">
            <input type="checkbox" name="tree-table-with-checkboxes-checkrow-16" aria-labelledby="tree-table-with-checkboxes-node-16" />
          </span>
          <div class="pf-c-table__tree-view-content">
            <span class="pf-c-table__text" id="tree-table-with-checkboxes-node-16">Level 4 leaf</span>
          </div>
        </div>
      </td>
      <td role="gridcell" data-label="Migration assessment">10</td>
    ...
    <tr aria-level="2" aria-setsize="5" aria-posinset="6" tabindex="0" aria-expanded="false" role="row">
      <td role="gridcell" data-label="Tree view content">
        <div class="pf-c-table__tree-view-main">
          <span class="pf-c-table__toggle" data-label="Tree view content">
            <button class="pf-c-button pf-m-plain" aria-labelledby="tree-table-with-checkboxes-node-17 tree-table-with-checkboxes-expandable-toggle-17" id="tree-table-with-checkboxes-expandable-toggle-17" aria-label="Details">
              <div class="pf-c-table__toggle-icon">
                <i class="fas fa-angle-down" aria-hidden="true"></i>
              </div>
            </button>
          ...
          <span class="pf-c-table__check" data-label="Tree view content">
            <input type="checkbox" name="tree-table-with-checkboxes-checkrow-17" aria-labelledby="tree-table-with-checkboxes-node-17" />
          </span>
          <div class="pf-c-table__tree-view-content">
            <span class="pf-c-table__text" id="tree-table-with-checkboxes-node-17">Level 2 node</span>
          </div>
        </div>
      </td>
      <td role="gridcell" data-label="Migration assessment">10</td>
    ...
    <tr aria-level="3" aria-setsize="2" aria-posinset="1" tabindex="-1" hidden role="row">
      <td role="gridcell" data-label="Tree view content">
        <div class="pf-c-table__tree-view-main">
          <span class="pf-c-table__check" data-label="Tree view content">
            <input type="checkbox" name="tree-table-with-checkboxes-checkrow-18" aria-labelledby="tree-table-with-checkboxes-node-18" />
          </span>
          <div class="pf-c-table__tree-view-content">
            <span class="pf-c-table__text" id="tree-table-with-checkboxes-node-18">Level 3 leaf</span>
          </div>
        </div>
      </td>
      <td role="gridcell" data-label="Migration assessment">10</td>
    ...
    <tr aria-level="3" aria-setsize="2" aria-posinset="2" tabindex="-1" hidden role="row">
      <td role="gridcell" data-label="Tree view content">
        <div class="pf-c-table__tree-view-main">
          <span class="pf-c-table__check" data-label="Tree view content">
            <input type="checkbox" name="tree-table-with-checkboxes-checkrow-19" aria-labelledby="tree-table-with-checkboxes-node-19" />
          </span>
          <div class="pf-c-table__tree-view-content">
            <span class="pf-c-table__text" id="tree-table-with-checkboxes-node-19">Level 3 leaf</span>
          </div>
        </div>
      </td>
      <td role="gridcell" data-label="Migration assessment">10</td>
...
```html
<table class="pf-c-table pf-m-tree-view pf-m-tree-view-checkboxes" role="treegrid" aria-label="This is a simple tree table, with checkboxes and icons example" id="tree-table-with-checkboxes-icons">
  <caption>This is the table caption</caption>
  <thead>
    <tr>
      <th scope="col">Name</th>
  ...
  <tbody>
    <tr aria-level="1" aria-setsize="1" aria-posinset="1" tabindex="0" aria-expanded="true" role="row">
      <td role="gridcell" data-label="Tree view content">
        <div class="pf-c-table__tree-view-main">
          <span class="pf-c-table__toggle" data-label="Tree view content">
            <button class="pf-c-button pf-m-plain pf-m-expanded" aria-labelledby="tree-table-with-checkboxes-icons-node-2 tree-table-with-checkboxes-icons-expandable-toggle-2" id="tree-table-with-checkboxes-icons-expandable-toggle-2" aria-label="Details" aria-expanded="true">
              <div class="pf-c-table__toggle-icon">
                <i class="fas fa-angle-down" aria-hidden="true"></i>
              </div>
            </button>
          ...
          <span class="pf-c-table__check" data-label="Tree view content">
            <input type="checkbox" name="tree-table-with-checkboxes-icons-checkrow-2" aria-labelledby="tree-table-with-checkboxes-icons-node-2" />
          </span>
          <div class="pf-c-table__tree-view-content">
            <span class="pf-c-table__tree-view-icon">
              <i class="fas fa-fw fa-folder" aria-hidden="true"></i>
            </span>
            <span class="pf-c-table__text" id="tree-table-with-checkboxes-icons-node-2">Level 1 all folders</span>
          </div>
        </div>
      </td>
      <td role="gridcell" data-label="Migration assessment">10</td>
    ...
    <tr aria-level="2" aria-setsize="5" aria-posinset="1" tabindex="0" aria-expanded="false" role="row">
      <td role="gridcell" data-label="Tree view content">
        <div class="pf-c-table__tree-view-main">
          <span class="pf-c-table__toggle" data-label="Tree view content">
            <button class="pf-c-button pf-m-plain" aria-labelledby="tree-table-with-checkboxes-icons-node-3 tree-table-with-checkboxes-icons-expandable-toggle-3" id="tree-table-with-checkboxes-icons-expandable-toggle-3" aria-label="Details">
              <div class="pf-c-table__toggle-icon">
                <i class="fas fa-angle-down" aria-hidden="true"></i>
              </div>
            </button>
          ...
          <span class="pf-c-table__check" data-label="Tree view content">
            <input type="checkbox" name="tree-table-with-checkboxes-icons-checkrow-3" aria-labelledby="tree-table-with-checkboxes-icons-node-3" />
          </span>
          <div class="pf-c-table__tree-view-content">
            <span class="pf-c-table__tree-view-icon">
              <i class="fas fa-fw fa-folder" aria-hidden="true"></i>
            </span>
            <span class="pf-c-table__text" id="tree-table-with-checkboxes-icons-node-3">Level 2 node</span>
          </div>
        </div>
      </td>
      <td role="gridcell" data-label="Migration assessment">10</td>
    ...
    <tr aria-level="3" aria-setsize="2" aria-posinset="1" tabindex="-1" hidden role="row">
      <td role="gridcell" data-label="Tree view content">
        <div class="pf-c-table__tree-view-main">
          <span class="pf-c-table__check" data-label="Tree view content">
            <input type="checkbox" name="tree-table-with-checkboxes-icons-checkrow-4" aria-labelledby="tree-table-with-checkboxes-icons-node-4" />
          </span>
          <div class="pf-c-table__tree-view-content">
            <span class="pf-c-table__tree-view-icon">
              <i class="fas fa-fw fa-leaf" aria-hidden="true"></i>
            </span>
            <span class="pf-c-table__text" id="tree-table-with-checkboxes-icons-node-4">Level 2 leaf</span>
          </div>
        </div>
      </td>
      <td role="gridcell" data-label="Migration assessment">10</td>
    ...
    <tr aria-level="3" aria-setsize="2" aria-posinset="2" tabindex="-1" hidden role="row">
      <td role="gridcell" data-label="Tree view content">
        <div class="pf-c-table__tree-view-main">
          <span class="pf-c-table__check" data-label="Tree view content">
            <input type="checkbox" name="tree-table-with-checkboxes-icons-checkrow-5" aria-labelledby="tree-table-with-checkboxes-icons-node-5" />
          </span>
          <div class="pf-c-table__tree-view-content">
            <span class="pf-c-table__tree-view-icon">
              <i class="fas fa-fw fa-leaf" aria-hidden="true"></i>
            </span>
            <span class="pf-c-table__text" id="tree-table-with-checkboxes-icons-node-5">Level 2 leaf</span>
          </div>
        </div>
      </td>
      <td role="gridcell" data-label="Migration assessment">10</td>
    ...
    <tr aria-level="2" aria-setsize="5" aria-posinset="2" tabindex="-1" role="row">
      <td role="gridcell" data-label="Tree view content">
        <div class="pf-c-table__tree-view-main">
          <span class="pf-c-table__check" data-label="Tree view content">
            <input type="checkbox" name="tree-table-with-checkboxes-icons-checkrow-6" aria-labelledby="tree-table-with-checkboxes-icons-node-6" />
          </span>
          <div class="pf-c-table__tree-view-content">
            <span class="pf-c-table__tree-view-icon">
              <i class="fas fa-fw fa-leaf" aria-hidden="true"></i>
            </span>
            <span class="pf-c-table__text" id="tree-table-with-checkboxes-icons-node-6">Level 2 leaf</span>
          </div>
        </div>
      </td>
      <td role="gridcell" data-label="Migration assessment">10</td>
    ...
    <tr aria-level="2" aria-setsize="5" aria-posinset="3" tabindex="-1" role="row">
      <td role="gridcell" data-label="Tree view content">
        <div class="pf-c-table__tree-view-main">
          <span class="pf-c-table__check" data-label="Tree view content">
            <input type="checkbox" name="tree-table-with-checkboxes-icons-checkrow-7" aria-labelledby="tree-table-with-checkboxes-icons-node-7" />
          </span>
          <div class="pf-c-table__tree-view-content">
            <span class="pf-c-table__tree-view-icon">
              <i class="fas fa-fw fa-leaf" aria-hidden="true"></i>
            </span>
            <span class="pf-c-table__text" id="tree-table-with-checkboxes-icons-node-7">Level 2 leaf</span>
          </div>
        </div>
      </td>
      <td role="gridcell" data-label="Migration assessment">10</td>
    ...
    <tr aria-level="2" aria-setsize="5" aria-posinset="4" tabindex="0" aria-expanded="true" role="row">
      <td role="gridcell" data-label="Tree view content">
        <div class="pf-c-table__tree-view-main">
          <span class="pf-c-table__toggle" data-label="Tree view content">
            <button class="pf-c-button pf-m-plain pf-m-expanded" aria-labelledby="tree-table-with-checkboxes-icons-node-8 tree-table-with-checkboxes-icons-expandable-toggle-8" id="tree-table-with-checkboxes-icons-expandable-toggle-8" aria-label="Details" aria-expanded="true">
              <div class="pf-c-table__toggle-icon">
                <i class="fas fa-angle-down" aria-hidden="true"></i>
              </div>
            </button>
          ...
          <span class="pf-c-table__check" data-label="Tree view content">
            <input type="checkbox" name="tree-table-with-checkboxes-icons-checkrow-8" aria-labelledby="tree-table-with-checkboxes-icons-node-8" />
          </span>
          <div class="pf-c-table__tree-view-content">
            <span class="pf-c-table__tree-view-icon">
              <i class="fas fa-fw fa-folder" aria-hidden="true"></i>
            </span>
            <span class="pf-c-table__text" id="tree-table-with-checkboxes-icons-node-8">Level 2 node</span>
          </div>
        </div>
      </td>
      <td role="gridcell" data-label="Migration assessment">10</td>
    ...
    <tr aria-level="3" aria-setsize="2" aria-posinset="3" tabindex="-1" role="row">
      <td role="gridcell" data-label="Tree view content">
        <div class="pf-c-table__tree-view-main">
          <span class="pf-c-table__check" data-label="Tree view content">
            <input type="checkbox" name="tree-table-with-checkboxes-icons-checkrow-9" aria-labelledby="tree-table-with-checkboxes-icons-node-9" />
          </span>
          <div class="pf-c-table__tree-view-content">
            <span class="pf-c-table__tree-view-icon">
              <i class="fas fa-fw fa-leaf" aria-hidden="true"></i>
            </span>
            <span class="pf-c-table__text" id="tree-table-with-checkboxes-icons-node-9">Level 3 leaf</span>
          </div>
        </div>
      </td>
      <td role="gridcell" data-label="Migration assessment">10</td>
    ...
    <tr aria-level="3" aria-setsize="2" aria-posinset="1" tabindex="0" aria-expanded="true" role="row">
      <td role="gridcell" data-label="Tree view content">
        <div class="pf-c-table__tree-view-main">
          <span class="pf-c-table__toggle" data-label="Tree view content">
            <button class="pf-c-button pf-m-plain pf-m-expanded" aria-labelledby="tree-table-with-checkboxes-icons-node-11 tree-table-with-checkboxes-icons-expandable-toggle-11" id="tree-table-with-checkboxes-icons-expandable-toggle-11" aria-label="Details" aria-expanded="true">
              <div class="pf-c-table__toggle-icon">
                <i class="fas fa-angle-down" aria-hidden="true"></i>
              </div>
            </button>
          ...
          <span class="pf-c-table__check" data-label="Tree view content">
            <input type="checkbox" name="tree-table-with-checkboxes-icons-checkrow-11" aria-labelledby="tree-table-with-checkboxes-icons-node-11" />
          </span>
          <div class="pf-c-table__tree-view-content">
            <span class="pf-c-table__tree-view-icon">
              <i class="fas fa-fw fa-folder" aria-hidden="true"></i>
            </span>
            <span class="pf-c-table__text" id="tree-table-with-checkboxes-icons-node-11">Level 3 node</span>
          </div>
        </div>
      </td>
      <td role="gridcell" data-label="Migration assessment">10</td>
    ...
    <tr aria-level="4" aria-setsize="1" aria-posinset="1" tabindex="-1" role="row">
      <td role="gridcell" data-label="Tree view content">
        <div class="pf-c-table__tree-view-main">
          <span class="pf-c-table__check" data-label="Tree view content">
            <input type="checkbox" name="tree-table-with-checkboxes-icons-checkrow-12" aria-labelledby="tree-table-with-checkboxes-icons-node-12" />
          </span>
          <div class="pf-c-table__tree-view-content">
            <span class="pf-c-table__tree-view-icon">
              <i class="fas fa-fw fa-leaf" aria-hidden="true"></i>
            </span>
            <span class="pf-c-table__text" id="tree-table-with-checkboxes-icons-node-12">Level 4 leaf</span>
          </div>
        </div>
      </td>
      <td role="gridcell" data-label="Migration assessment">10</td>
    ...
    <tr aria-level="3" aria-setsize="2" aria-posinset="2" tabindex="-1" role="row">
      <td role="gridcell" data-label="Tree view content">
        <div class="pf-c-table__tree-view-main">
          <span class="pf-c-table__check" data-label="Tree view content">
            <input type="checkbox" name="tree-table-with-checkboxes-icons-checkrow-13" aria-labelledby="tree-table-with-checkboxes-icons-node-13" />
          </span>
          <div class="pf-c-table__tree-view-content">
            <span class="pf-c-table__tree-view-icon">
              <i class="fas fa-fw fa-leaf" aria-hidden="true"></i>
            </span>
            <span class="pf-c-table__text" id="tree-table-with-checkboxes-icons-node-13">Level 3 leaf</span>
          </div>
        </div>
      </td>
      <td role="gridcell" data-label="Migration assessment">10</td>
    ...
    <tr aria-level="3" aria-setsize="2" aria-posinset="5" tabindex="0" aria-expanded="true" role="row">
      <td role="gridcell" data-label="Tree view content">
        <div class="pf-c-table__tree-view-main">
          <span class="pf-c-table__toggle" data-label="Tree view content">
            <button class="pf-c-button pf-m-plain pf-m-expanded" aria-labelledby="tree-table-with-checkboxes-icons-node-14 tree-table-with-checkboxes-icons-expandable-toggle-14" id="tree-table-with-checkboxes-icons-expandable-toggle-14" aria-label="Details" aria-expanded="true">
              <div class="pf-c-table__toggle-icon">
                <i class="fas fa-angle-down" aria-hidden="true"></i>
              </div>
            </button>
          ...
          <span class="pf-c-table__check" data-label="Tree view content">
            <input type="checkbox" name="tree-table-with-checkboxes-icons-checkrow-14" aria-labelledby="tree-table-with-checkboxes-icons-node-14" />
          </span>
          <div class="pf-c-table__tree-view-content">
            <span class="pf-c-table__tree-view-icon">
              <i class="fas fa-fw fa-folder" aria-hidden="true"></i>
            </span>
            <span class="pf-c-table__text" id="tree-table-with-checkboxes-icons-node-14">Level 3 node</span>
          </div>
        </div>
      </td>
      <td role="gridcell" data-label="Migration assessment">10</td>
    ...
    <tr aria-level="4" aria-setsize="2" aria-posinset="1" tabindex="-1" role="row">
      <td role="gridcell" data-label="Tree view content">
        <div class="pf-c-table__tree-view-main">
          <span class="pf-c-table__check" data-label="Tree view content">
            <input type="checkbox" name="tree-table-with-checkboxes-icons-checkrow-15" aria-labelledby="tree-table-with-checkboxes-icons-node-15" />
          </span>
          <div class="pf-c-table__tree-view-content">
            <span class="pf-c-table__tree-view-icon">
              <i class="fas fa-fw fa-leaf" aria-hidden="true"></i>
            </span>
            <span class="pf-c-table__text" id="tree-table-with-checkboxes-icons-node-15">Level 4 leaf</span>
          </div>
        </div>
      </td>
      <td role="gridcell" data-label="Migration assessment">10</td>
    ...
    <tr aria-level="4" aria-setsize="2" aria-posinset="2" tabindex="-1" role="row">
      <td role="gridcell" data-label="Tree view content">
        <div class="pf-c-table__tree-view-main">
          <span class="pf-c-table__check" data-label="Tree view content">
            <input type="checkbox" name="tree-table-with-checkboxes-icons-checkrow-16" aria-labelledby="tree-table-with-checkboxes-icons-node-16" />
          </span>
          <div class="pf-c-table__tree-view-content">
            <span class="pf-c-table__tree-view-icon">
              <i class="fas fa-fw fa-leaf" aria-hidden="true"></i>
            </span>
            <span class="pf-c-table__text" id="tree-table-with-checkboxes-icons-node-16">Level 4 leaf</span>
          </div>
        </div>
      </td>
      <td role="gridcell" data-label="Migration assessment">10</td>
    ...
    <tr aria-level="2" aria-setsize="5" aria-posinset="6" tabindex="0" aria-expanded="false" role="row">
      <td role="gridcell" data-label="Tree view content">
        <div class="pf-c-table__tree-view-main">
          <span class="pf-c-table__toggle" data-label="Tree view content">
            <button class="pf-c-button pf-m-plain" aria-labelledby="tree-table-with-checkboxes-icons-node-17 tree-table-with-checkboxes-icons-expandable-toggle-17" id="tree-table-with-checkboxes-icons-expandable-toggle-17" aria-label="Details">
              <div class="pf-c-table__toggle-icon">
                <i class="fas fa-angle-down" aria-hidden="true"></i>
              </div>
            </button>
          ...
          <span class="pf-c-table__check" data-label="Tree view content">
            <input type="checkbox" name="tree-table-with-checkboxes-icons-checkrow-17" aria-labelledby="tree-table-with-checkboxes-icons-node-17" />
          </span>
          <div class="pf-c-table__tree-view-content">
            <span class="pf-c-table__tree-view-icon">
              <i class="fas fa-fw fa-folder" aria-hidden="true"></i>
            </span>
            <span class="pf-c-table__text" id="tree-table-with-checkboxes-icons-node-17">Level 2 node</span>
          </div>
        </div>
      </td>
      <td role="gridcell" data-label="Migration assessment">10</td>
    ...
    <tr aria-level="3" aria-setsize="2" aria-posinset="1" tabindex="-1" hidden role="row">
      <td role="gridcell" data-label="Tree view content">
        <div class="pf-c-table__tree-view-main">
          <span class="pf-c-table__check" data-label="Tree view content">
            <input type="checkbox" name="tree-table-with-checkboxes-icons-checkrow-18" aria-labelledby="tree-table-with-checkboxes-icons-node-18" />
          </span>
          <div class="pf-c-table__tree-view-content">
            <span class="pf-c-table__tree-view-icon">
              <i class="fas fa-fw fa-leaf" aria-hidden="true"></i>
            </span>
            <span class="pf-c-table__text" id="tree-table-with-checkboxes-icons-node-18">Level 3 leaf</span>
          </div>
        </div>
      </td>
      <td role="gridcell" data-label="Migration assessment">10</td>
    ...
    <tr aria-level="3" aria-setsize="2" aria-posinset="2" tabindex="-1" hidden role="row">
      <td role="gridcell" data-label="Tree view content">
        <div class="pf-c-table__tree-view-main">
          <span class="pf-c-table__check" data-label="Tree view content">
            <input type="checkbox" name="tree-table-with-checkboxes-icons-checkrow-19" aria-labelledby="tree-table-with-checkboxes-icons-node-19" />
          </span>
          <div class="pf-c-table__tree-view-content">
            <span class="pf-c-table__tree-view-icon">
              <i class="fas fa-fw fa-leaf" aria-hidden="true"></i>
            </span>
            <span class="pf-c-table__text" id="tree-table-with-checkboxes-icons-node-19">Level 3 leaf</span>
          </div>
        </div>
      </td>
      <td role="gridcell" data-label="Migration assessment">10</td>
...
&nbsp; 2
      ...
      <td class="pf-c-table__compound-expansion-togglepf-m-expanded pf-m-expanded" role="cell" data-label="Branches">
        <button class="pf-c-table__button">
          <span class="pf-c-table__text">
            <i class="fas fa-code" aria-hidden="true"></i>
&nbsp; 82
