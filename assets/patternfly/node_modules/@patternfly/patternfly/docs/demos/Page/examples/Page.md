...
<div class="pf-c-page" id="page-demo-masthead-component">
  <header class="pf-c-page__header">
    <a class="pf-c-skip-to-content pf-c-button pf-m-primary" href="#main-content-page-demo-masthead-component">Skip to content</a>
  ...
  <div class="pf-c-page__sidebar">
    <div class="pf-c-page__sidebar-body">
      <nav class="pf-c-nav" id="page-demo-masthead-component-primary-nav" aria-label="Global">
  ...
  <main class="pf-c-page__main" tabindex="-1" id="main-content-page-demo-masthead-component">
